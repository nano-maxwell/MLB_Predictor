...
for idx, row in tqdm(df.iterrows(), total=len(df), desc="Processing games", colour="cyan"):
    ...
    feat = {
        ...
        "home_pitcher_era": get_pitcher_stat_cached(player_name=home_starter, stat="era") if home_starter != None else 4.25,
        "away_pitcher_era": get_pitcher_stat_cached(player_name=away_starter, stat="era") if away_starter != None else 4.25,
        "home_pitcher_whip": get_pitcher_stat_cached(player_name=home_starter, stat="whip") if home_starter != None else 1.35,
        "away_pitcher_whip": get_pitcher_stat_cached(player_name=away_starter, stat="whip") if away_starter != None else 1.35,
